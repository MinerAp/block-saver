...
public final class PrismBlockReinforceListener extends BaseEventHandler<BlockReinforceEvent> {
    private final ReinforcementManager reinforcementManager;
    private final BlockSaverInfoManager infoManager;

    public PrismBlockReinforceListener(final BlockSaverConfigurationContext configurationContext) {
