...
public final class PrismReinforcedBlockDamageListener extends BaseEventHandler<ReinforcedBlockDamageEvent> {
    private final ReinforcementManager reinforcementManager;
    private final BlockSaverInfoManager infoManager;

    public PrismReinforcedBlockDamageListener(final BlockSaverConfigurationContext configurationContext) {
